            ...
            <div>
                <div className='w-full flex flex-col items-center justify-center'>
                    <div className='max-w-[1000px] w-full mt-[50px] md:mt-[150px]'>
                        <div className='flex flex-col gap-[50px] md:gap-[150px] ml-5 md:ml-0 mr-5 md:mr-0'>
                            <div className='flex flex-col gap-[10px] md:gap-[50px]'>
                                <div className='flex flex-col md:w-[863px] text-base md:text-5xl font-bold text-left leading-[1.20]'>
                                    <div className={`${language === 'en' ? 'font-bold md:w-[863px]': 
                                                        language === 'zh' ? 'font-bold md:w-[1000px]': 
                            ...
                            <div className='flex flex-col gap-[30px] md:gap-[150px]'>
                                <div className='flex flex-col gap-[10px] md:gap-[30px]'>
                                    ...
                                    <div className='text-[#666] text-base md:text-4xl font-medium text-left md:w-[1000px] leading-tight'>
                                        <div className='text-[#666] text-sm md:text-2xl font-medium text-left md:w-[1000px]'>
                                            <div className='flex flex-col leading-[1.20]'>
                                                <div className={`${language === 'en' ? 'font-semibold w-[353px] md:w-[1000px]': 
                                                                    language === 'zh' ? 'font-semibold w-[353px] md:w-[1000px]': 
                                                                    language === 'bm' ? 'font-semibold w-[353px] md:w-[1000px]': ''}`}>
                                ...
                                <div className='flex flex-col gap-5'>
                                    <div className='flex justify-left'>
                                        <div className='flex flex-row items-center'>
                                            ...
                                            <div className='w-[303px] md:w-[863px] text-base md:text-[32px] font-semibold md:font-bold text-left mx-6'>
                        ...
                        <div className='flex flex-col gap-[50px] md:gap-[150px] ml-5 md:ml-0 mr-5 md:mr-0'>
                            <div className='flex flex-col gap-[30px] md:gap-[100px]'>
                                <div className='flex flex-col gap-5 md:gap-[30px]'>
                                    ...
                                    <div className='text-[#666] text-sm md:text-2xl font-semibold text-left md:w-[1000px]'>
                                        <div className='flex flex-col leading-[1.20]'>
                                            <div className={`${language === 'en' ? 'font-semibold w-[353px] md:w-[1000px]': 
                                                                language === 'zh' ? 'font-semibold w-[353px] md:w-[1000px]': 
                                                                language === 'bm' ? 'font-semibold w-[353px] md:w-[1000px]': ''}`}>
