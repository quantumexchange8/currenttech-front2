        ...
        <div>
            <div className='relative'>
                ...
                <div className='absolute left-[100px] bottom-[100px] flex flex-col text-white text-left gap-5'>
                    <span className='text-5xl font-bold'>Career Opportunities </span>
            ...
            <div>
                <div className='w-full flex flex-col items-center justify-center'>
                    <div className='max-w-[1000px] w-full mt-[150px]'>
                            ...
                            <div className='flex flex-col gap-4'>
                                <div className='flex justify-left'>
                                        <div className='flex flex-row'>
                                            ...
                                            <div className='md:w-[863px] text-4xl font-bold text-left mx-6'>
                                                Skill & Experience
                                            </div>
                                        </div>
                                ...
                                <ul class="list-disc list-inside text-[#666] text-4xl text-left font-bold mx-24"> 
                                    ...
                                    <li>JAVA SCRIPT</li>
                                    <li>MQL4 & MQL5</li>
                                    <li className='mt-12' >AT LEAST 1 YEAR(S) OF EXPERIENCE.</li>
                        ...
                        <div className='flex flex-col md:gap-[100px]'>
                            ...
                            <div className='flex flex-col gap-4'>
                                ...
                                <ul className="list-disc list-inside text-[#666] text-4xl text-left font-bold mx-24"> 
                                    ...
                                    <li>JAVA SCRIPT</li>
                                    <li>MQL4 & MQL5</li>
                                    <li className='mt-12'>FIGMA</li>
                                    <li>PHOTOSHOP</li>
                                    <li>ILLUSTRATOR</li>
                                    <li>SKETCH</li>
                                    <li>ADOBE XD</li>
                                    <li className='mt-12' >DEGREE HOLDER</li>
            ...
            <div>
                <div className='flex flex-col gap-[66px] my-[150px] items-center justify-center'>
                        <div className='max-w-[1000px] w-full mt-[50px]'>
                            <div className='flex flex-col md:gap-[30px]'>
                                <div className='text-5xl font-bold text-left'>
                                    Don't hesitate!
                                </div>
                                <div className='flex flex-col text-[#000] text-2xl font-bold text-left'>
