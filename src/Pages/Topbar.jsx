...
import { Earphone, Lang, Menus, MenusM } from '../Components/Outline';
                    ...
                    <div className='md:hidden flex w-full justify-between items-center py-[10px] px-[25px]'>
                        ...
                        <div>
                            <button 
                                ...
                                className="flex  rounded-md text-sm font-medium text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75">
                                <MenusM />
                            </button>
                        </div>
                    </div>
